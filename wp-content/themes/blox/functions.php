...
if ( !function_exists( 'zilla_enqueue_scripts' ) ) {
	function zilla_enqueue_scripts() {
		...
		wp_register_script('superfish', get_template_directory_uri() . '/js/superfish.js', 'jquery', '1.7.4');
		...
		wp_register_script('zilla-custom', get_template_directory_uri() . '/js/jquery.custom.js', array('jquery', 'superfish', 'fitVids', 'flexslider'), '1.2', TRUE);
...
if ( !function_exists( 'zilla_gallery' ) ) {
    function zilla_gallery($postid, $imagesize, $slideshow = false, $thumbs = false) { 
        global $is_iphone;
